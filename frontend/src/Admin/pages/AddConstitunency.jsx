...
export default function ConstituencyManagement() {
  ...
  const handleOpenGovernment = (government) => {
    ...
    navigate(
      `/admin/constituencies/${government.slug}`
    )
  }
      ...
      <div className={Styles.managementPage}>
        ...
        <div className={Styles.managementHeader}>
          ...
          <div>
            ...
            <h1 className={Styles.managementTitle}>
              Constituency Management
            </h1>

            <p className={Styles.managementSubtitle}>
              Manage local, state and national government
              constituencies.
            </p>
          ...
          {GOV_BODY_CARDS.map((government) => {
            ...
            return (
              ...
              >
                ...
                <button
                  type="button"
                  className={Styles.govViewBtn}
                  onClick={() =>
                    handleOpenGovernment(
                      government
                    )
                  }
                >
