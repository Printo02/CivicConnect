...
import { FaUser, FaPalette, FaLock, FaSun, FaMoon, FaCheck, FaBuilding } from "react-icons/fa";
...
function ProfileTab() {
  ...
  return (
    <form className={Styles.form} onSubmit={handleSubmit}>
      ...
      <p className={Styles.panelSubtitle}>Manage your branch information and contact details.</p>
      <div className={Styles.formSection}>
        <h4 className={Styles.sectionTitle}> DEPARTMENT </h4>
        <div className={Styles.fieldGrid}>
          {/* Phone */}
          <label className={Styles.field}>
            <input type="text" name="deptname" value={form.deptname} disabled onChange={handleChange} placeholder="Department Name" />
          </label>
        </div>
      </div>
      <div className={Styles.formSection}>
        ...
        <div className={Styles.fieldGrid}>
          ...
          <label className={Styles.field}>
            ...
            <input type="text" name="deptname" value={form.placename}  disabled onChange={handleChange}
...
function ThemeTab() {
  ...
  return (
    ...
    <div className={Styles.form}>
      ...
      <p className={Styles.panelSubtitle}>Choose how CivicConnect looks on your device.</p>
...
function PasswordTab() {
  ...
  return (
    <form className={Styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <p className={Styles.panelSubtitle}>Choose a strong password for your branch account.</p>
