...
import {
  ...
  getRepresentativeComplaintResponses,
  createRepresentativeComplaintResponse,
  updateRepresentativeComplaint,
} from "../../api/services/Representative/representativeComplaintApi";
...
export default function RepresentativeComplaintDetail() {
  const { id } = useParams();
  ...
  const loadComplaint = async () => {
    try {
      ...
      const data =
        await getRepresentativeComplaint(id);
      ...
      console.error(
        "Failed to load representative complaint:",
        err
      );
  ...
  const loadResponses = async () => {
    try {
      ...
      const data =
        await getRepresentativeComplaintResponses(id);
  ...
  const submitResponse = async (event) => {
    ...
    try {
      ...
      await createRepresentativeComplaintResponse(
        id,
        trimmedResponse,
        responseFile ? [responseFile] : []
      );

      await updateRepresentativeComplaint(id, {
        status,
      });
      ...
      console.error(
        "Failed to create representative response:",
        err
      );
        ...
        <div className={styles.detailGrid}>
          ...
          >
            ...
            >
              ...
              <div className={styles.responseField}>
                <label htmlFor="representative-response">
                  Response
                </label>
              ...
              <div className={styles.responseAttachmentField}>
                <label htmlFor="representative-response-file">
                  Attachment
                </label>
                ...
                <div className={styles.fileUploadBox}>
                  ...
                  <label
                    htmlFor="representative-response-file"
                  ...
                  <input
                    id="representative-response-file"
                    type="file"
                    onChange={(event) => {
                      const file =
