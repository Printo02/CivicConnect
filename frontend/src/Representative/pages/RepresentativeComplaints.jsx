...
export default function RepresentativeComplaints() {
  ...
  const loadComplaints = async () => {
    try {
      ...
      const data = await getRepresentativeComplaints();

      console.log(
        "Representative complaints API response:",
        data
      );
      ...
      console.error(
        "Failed to load representative complaints:",
        err
      );
  ...
  const openComplaint = (id) => {
     ...
     * This is used by the RepresentativeLayout sidebar
     * notification badge.
     */
    const seenIds = JSON.parse(
      localStorage.getItem(
        "representative_seen_complaints"
      ) || "[]"
    );
      ...
      <div className={styles.page}>
        ...
        <div className={styles.header}>
          <div>
            ...
            <p>
              Complaints assigned to your constituency.
            </p>
          </div>
